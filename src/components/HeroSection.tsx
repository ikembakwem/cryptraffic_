      ...
      <div className="flex max-w-heroContainer px-4 largePhone:px-14 py-6 mx-auto shrink-0">
        <div className="flex items-center">
          <div className={classes.leftContainer}>
            <HeroPill />
            <h1 className="text-4xl largePhone:text-6xl mt-2 mb-4 leading-tighter font-medium max-w-full">
              <span className="inline-block md:max-w-heroCopy">
                Jump start your crypto portfolio
              </span>
            </h1>
            <p className="largePhone:text-xl mb-8 leading-snug largePhone:font-medium">
